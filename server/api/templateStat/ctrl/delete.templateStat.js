...
export default function deleteTemplateStat (req, res) {
  TemplateStat.remove(parseInt(req.params.id))
    .then((bSucceded) => {
      if (bSucceded) {
    ...
    .catch((err) => {
      ...
      const jsonErr = { code: err.code, message: 'Error while deleting the new templateStat.\n' }
