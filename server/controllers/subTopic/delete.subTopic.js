...
export default function deleteSubTopic (req, res) {
  SubTopic.remove(parseInt(req.params.id))
    .then((bSucceded) => {
      if (bSucceded) {
    ...
    .catch((err) => {
      ...
      const jsonErr = { code: err.code, message: 'Error while deleting the new subTopic.\n' }
