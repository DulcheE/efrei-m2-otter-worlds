...
CREATE TABLE IF NOT EXISTS `otter_worlds`.`keyword` (
  ...
  INDEX `fk_keyword_universe1_idx` (`universe_idUniverse` ASC) VISIBLE,
  UNIQUE INDEX `un_name_universe` (`name` ASC, `universe_idUniverse` ASC) VISIBLE,
  CONSTRAINT `fk_keyword_universe1`
    FOREIGN KEY (`universe_idUniverse`)
    REFERENCES `otter_worlds`.`universe` (`idUniverse`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `otter_worlds`.`keywordArticle` (
  ...
  INDEX `fk_keyWords_has_article_keyWords1_idx` (`keyword_idKeyword` ASC) VISIBLE,
  UNIQUE INDEX `un_keyword_article` (`keyword_idKeyword` ASC, `article_idArticle` ASC) VISIBLE,
