...
CREATE TABLE IF NOT EXISTS `otter_worlds`.`topic` (
  ...
  `name` VARCHAR(45) NOT NULL,
  `order` INT NOT NULL,
  `universe_idUniverse` INT NOT NULL DEFAULT -1,
...
CREATE TABLE IF NOT EXISTS `otter_worlds`.`subTopic` (
  ...
  `name` VARCHAR(45) NOT NULL,
  `order` INT NOT NULL,
  `topic_idTopic` INT NOT NULL DEFAULT -1,
  `article_idArticle` INT NULL,
...
CREATE TABLE IF NOT EXISTS `otter_worlds`.`interestPoint` (
  `idInterestPoint` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  `coordinate` VARCHAR(45) NOT NULL,
  `map_idMap` INT NOT NULL DEFAULT -1,
  `article_idArticle` INT NULL,
...
CREATE TABLE IF NOT EXISTS `otter_worlds`.`character` (
  ...
  `name` VARCHAR(45) NOT NULL,
  `backstory` TEXT NULL,
  `bIsAlive` TINYINT NOT NULL DEFAULT 1,
  `sheetStatus` ENUM('Work In Progress', 'To validate', 'Refused', 'Validated') NOT NULL DEFAULT 'Work In Progress',
  `user_idUser` INT NOT NULL DEFAULT -1,
  `universe_idUniverse` INT NOT NULL DEFAULT -1,
...
CREATE TABLE IF NOT EXISTS `otter_worlds`.`templateStat` (
  ...
  `templateCategory_idTemplateCategory` INT NOT NULL DEFAULT -1,
...
CREATE TABLE IF NOT EXISTS `otter_worlds`.`stat` (
  ...
  `character_idCharacter` INT NOT NULL DEFAULT -1,
  `templateStat_idTemplateStat` INT NOT NULL DEFAULT -1,
...
CREATE TABLE IF NOT EXISTS `otter_worlds`.`keyword` (
  ...
  INDEX `fk_keyword_article1_idx` (`article_idArticle` ASC) VISIBLE,
  UNIQUE INDEX `un_name_article` (`name` ASC, `article_idArticle` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `otter_worlds`.`event` (
  ...
  `article_idArticle` INT NULL,
  `timeline_idTimeline` INT NOT NULL DEFAULT -1,
  PRIMARY KEY (`idEvent`),
