    ...
    <v-list>
      ...
      >
        <template v-slot:activator>
          <v-list-item-content>
            <v-list-itel-title v-text="truc.name" />
          </v-list-item-content>
        </template>
